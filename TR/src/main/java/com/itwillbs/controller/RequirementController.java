...
public class RequirementController {
	 ...
	 * service.insertProd(DTO);
	 * 
	 * return "redirect:/requirement/product"; }
	 */
	 ...
	 * 
	 * return "redirect:/requirement/product"; } // deleteProd()
	 */
	/*
	 * // 품목관리 조회 POST
	 * 
	 ...
	 * 
	 * //서비스 - 작업지시 수정 service.modifyProd(uDTO);
	 * 
	 * return "redirect:/requirement/product"; } //modifyProd()
	 */
	// =====================================================================================

	/*
	 * // 원자재관리 // http://localhost:8088/requirement/rawMaterial
	 * 
	 * @RequestMapping(value = "/rawMaterial", method = RequestMethod.GET) public
	 * void rawMaterialGET(Model model, RawMaterialDTO dto, RequirementPageDTO pdto,
	 * 
	 * @RequestParam(value = "nowPage", required = false) String nowPage,
	 * 
	 * @RequestParam(value = "cntPerPage", required = false) String cntPerPage,
	 ...
	 * Exception {
	 * 
	 * logger.debug("rawMaterialGET() 호출"); List<RawMaterialDTO> raws = new
	 * ArrayList<RawMaterialDTO>(); model.addAttribute("raws", raws);
	 * logger.debug("DTO : " + dto);
	 * 
	 * if (DTO.getRawCode() != null || dto.getClients().getClient_actname() != null
	 * || dto.getRaw_name() != null) {
	 * 
	 * logger.debug("if문 호출"); int total = service.countRaw(DTO); pdto = new
	 * RequirementPageDTO(total, pdto.getNowPage(), pdto.getCntPerPage());
	 * List<RawMaterialDTO> list = service.getRawList(DTO, pdto);
	 * model.addAttribute("rawList", list); model.addAttribute("paging", pdto);
	 * model.addAttribute("DTO", dto); logger.debug("pdto : " + pdto);
	 * logger.debug("DTO : " + dto);
	 * 
	 * logger.debug("검색 리스트 가져감");
	 * 
	 ...
	 * logger.debug("@@@@@@@@@@@@@@@@ input 정보 전달 @@@@@@@@@@@@@@@@"); }
	 * 
	 * } else { logger.debug("else문 호출"); int total = service.countRaw(); pdto = new
	 * RequirementPageDTO(total); logger.debug("pdto : " + pdto);
	 * List<RawMaterialDTO> list = service.getRawList(pdto);
	 * model.addAttribute("rawList", list); model.addAttribute("paging", pdto);
	 * logger.debug(" 모든 리스트 가져감"); }
	 * 
	 * }
	 ...
	 * service.insertProd(DTO);
	 * 
	 * return "redirect:/requirement/rawMaterial"; }
	 */
	 ...
	 * 
	 * return "redirect:/requirement/rawMaterial"; } // deleteRawMaterial()
	 */
	// 원자재관리 조회 POST
	/*
	 * @ResponseBody
	 ...
	 * RawMaterialDTO getRaw(@RequestBody RawMaterialDTO dto) throws Exception {
	 * logger.debug("@@@@@ CONTROLLER: getRaw() 호출");
	 * logger.debug("@@@@@ CONTROLLER: raw_Code = " + dto.getRawCode());
	 * 
	 * // 서비스 - 원자재관리 정보 가져오기 RawMaterialDTO preDTO =
	 * service.getRaw(DTO.getRawCode()); logger.debug("@@@@@ CONTROLLER: preDTO = "
	 * + preDTO);
	 * 
	 * return preDTO; } // getProd()
	 */
	 ...
	 * String modifyRaw(RawMaterialDTO uDTO) throws Exception {
	 * logger.debug("@@@@@ CONTROLLER: modifyRaw() 호출");
	 * logger.debug("@@@@@ CONTROLLER: uDTO = " + uDTO);
	 * 
	 * // 서비스 - 원자재관리 수정 service.modifyRaw(uDTO);
	 * 
	 * return "redirect:/requirement/rawMaterial"; } // modifyRaw()
	 */
	// =====================================================================================
