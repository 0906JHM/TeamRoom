...
function newTabUpdate() {
	...
	window.open("${pageContext.request.contextPath}/stock/updateP?stockNum="+ch, "수정",  "location=0,status=1,scrollbars=1,resizable=1,menubar=0,toolbar=no,width=600,height=500");
}
